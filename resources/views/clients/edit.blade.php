                        ...
                        <div class="space-y-12">
                            <div class="border-b border-gray-900/10 pb-12">
                                ...
                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <div class="mt-2">
                                            <input type="text" name="curp" id="curp" autocomplete="curp"
                                                maxlength="18" value="{{ $client->curp ?? '' }}"
                                    ...
                                    <div class="sm:col-span-2">
                                        <label for="phone"
                                            class="block text-sm font-medium leading-6 text-gray-900">Contrase SIEC</label>
                                        <div class="mt-2">
                                     ...
                                     <div class="sm:col-span-2">
                                        ...
                                        <div class="mt-2">
                                            <input type="text" name="regime_id" id="regime_id"
                                                autocomplete="regime_id" value="{{ $client->regime_id ?? '' }}"
                                                placeholder="{{ $client->regime_id ? '' : 'No hay datos existentes' }}"
                                                maxlength="18"
                                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    ...
                                    <div class="sm:col-span-2">
                                     ...
                                     <div class="sm:col-span-2">
                                        <label for="regime_id"
                                            class="block text-sm font-medium leading-6 text-gray-900">Usuario SIPARE</label>
                                        <div class="mt-2">
                                            <input type="text" name="regime_id" id="regime_id"
                                                autocomplete="regime_id" value="{{ $client->regime_id ?? '' }}"
                                                placeholder="{{ $client->regime_id ? '' : 'No hay datos existentes' }}"
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <div class="mt-2">
                                            <input type="text" name="city" id="city" autocomplete="city"
                                                maxlength="18" value="{{ $client->city ?? '' }}"

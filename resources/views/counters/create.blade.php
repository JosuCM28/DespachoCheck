                ...
                <form action="{{route('counter.store')}}" method="post">
                    ...
                    <div class="space-y-12">
                        <div class="border-b border-gray-900/10 pb-12">
                            ...
                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="regimen" id="regimen" autocomplete="regimen"
                                            maxlength="18"
                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        ...
                        <div class="mt-6 pb-2 flex items-center justify-end gap-x-6">
                            <a href="#" onclick="history.back()" class="text-sm font-semibold leading-6 text-gray-900">Cancelar</a>
                            <button type="submit"

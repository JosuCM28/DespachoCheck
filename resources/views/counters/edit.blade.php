                        ...
                        <div class="space-y-12">
                            <div class="border-b border-gray-900/10 pb-12">
                                ...
                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="name" id="name" autocomplete="given-name" value="{{$counter->name ?? '' }}" placeholder="{{ $counter->name ? '' : 'No hay datos existentes' }}"
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="last_name" id="last_name" autocomplete="family-name" value="{{$counter->last_name ?? ''}}" placeholder="{{ $counter->last_name ? '' : 'No hay datos existentes' }}"
                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        @error('last_name')
                                            <span class="text-red-500 text-sm">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input id="email" name="email" type="email" autocomplete="email" value="{{$counter->user->email ?? ''}}" placeholder="{{ $counter->user->email ? '' : 'No hay datos existentes' }}"
                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                ...
                                <div class="sm:col-span-2 sm:col-start-1">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="rfc" id="rfc" autocomplete="address-level2" value="{{$counter->rfc ?? ''}}" placeholder="{{ $counter->rfc ? '' : 'No hay datos existentes' }}"
                                            maxlength="13"
                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="curp" id="curp" autocomplete="curp" maxlength="18" value="{{$counter->curp ?? ''}}" placeholder="{{ $counter->curp ? '' : 'No hay datos existentes' }}"
                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <div class="mt-2">
                                        <input id="phone" name="phone" type="text" value="{{$counter->phone ?? ''}}" placeholder="{{ $counter->phone ? '' : 'No hay datos existentes' }}"
                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        @error('phone')
                                            <span class="text-red-500 text-sm">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="sm:col-span-2 sm:col-start-1">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="address" id="address" autocomplete="address-level2" value="{{$counter->address ?? ''}}" placeholder="{{ $counter->address ? '' : 'No hay datos existentes' }}"
                                            maxlength="13"
                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="city" id="city" autocomplete="city" maxlength="18" value="{{$counter->city ?? ''}}" placeholder="{{ $counter->city ? '' : 'No hay datos existentes' }}"
                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <div class="mt-2">
                                        <input id="cp" name="cp" type="text" value="{{$counter->cp ?? ''}}" placeholder="{{ $counter->cp ? '' : 'No hay datos existentes' }}"
                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        @error('cp')
                                            <span class="text-red-500 text-sm">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <div class="mt-2">
                                        <input id="state" name="state" type="text" value="{{$counter->state ?? ''}}" placeholder="{{ $counter->state ? '' : 'No hay datos existentes' }}"
                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        @error('state')
                                            <span class="text-red-500 text-sm">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="sm:col-span-2">
                                    <label for="birthdate"
                                        ...
                                        Nacimiento</label>
                                    <div class="mt-2">
                                        <input type="date" name="birthdate" id="birthdate" min="1900-1-1" value="{{$counter->birthdate ?? ''}}" placeholder="{{ $counter->birthdate ? '' : 'No hay datos existentes' }}" 
                            ...
                            <div class="mt-6 flex items-center justify-end gap-x-6">
                                <a href="{{url()->previous()}}" class="text-sm font-semibold leading-6 text-gray-900">Cancelar</a>

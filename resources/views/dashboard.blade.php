                            ...
                            <div
                                ...
                                <a href="{{ route('counter.create') }}">
                                    <div class="flex gap-2 flex-col justify-center items-center">
                                        ...
                                        <h5 class="text-2xl font-semibold tracking-tight text-gray-900">Agregar contador
                                        </h5>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="text-white p-4">
                            <div
                                ...
                                <a href="#">
                                    <div class="flex gap-2 flex-col justify-center items-center">
                                        <i class="fa-solid fa-user-plus text-3xl" style="color: #000000;"></i>
                                        <h5 class="text-2xl font-semibold tracking-tight text-gray-900">Agregar Cliente
                                        </h5>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div
                                ...
                                <a href="#">
                                    <div class="flex gap-2 flex-col justify-center items-center">
                                        ...
                                        <h5 class="text-2xl font-semibold tracking-tight text-gray-900">Crear Recibo
                                        </h5>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div
                                ...
                                <a href="#">
                                    <div class="flex gap-2 flex-col justify-center items-center">
                                        ...
                                        <h5 class="text-2xl font-semibold tracking-tight text-gray-900">Ver Contadores
                                        </h5>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="text-white p-4">
                            <div
                                ...
                                <a href="#">
                                    <div class="flex gap-2 flex-col justify-center items-center">
                                        <i class="fa-solid fa-eye text-3xl" style="color: #000000;"></i>
                                        <h5 class="text-2xl font-semibold tracking-tight text-gray-900">Ver Clientes
                                        </h5>
                                    </div>
                                </a>
                            </div>
